...
2. the prompts for monitoring require instant activation of keypresses, this has GPT infected a few other prompts, so, the infected prompts must be reverted or all prompts must now have this for consistency.
